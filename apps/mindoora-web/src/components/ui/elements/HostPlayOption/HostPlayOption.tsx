...
import { Styled } from "./HostPlayOption.styled";

interface HostPlayOptionProps {
  isChecked: boolean;
  onChangeHandler: (e: ChangeEvent<HTMLInputElement>) => void;
}

export const HostPlayOption = ({
  isChecked,
  onChangeHandler,
}: HostPlayOptionProps) => {
  return (
    <Styled.OptionWrapper>
      <label className="container" onChange={(e) => onChangeHandler(e)}>
        ...
        <div className="checkmark cursor-pointer">
          ...
          <p className="No name">Host not playing</p>
          <svg
            viewBox="0 0 16 16"
            className="icon Yes"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="Yes name">Host is playing</p>
        </div>
      </label>
    </Styled.OptionWrapper>
  );
